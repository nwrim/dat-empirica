    ...
    return (
      <Centered>
        <div className="instructions">
          ...
          <p>
            Again, you will be asked to come up with a list of nouns that are {" "}<strong>as different from each other as possible, in all meanings and uses of the words</strong>{" "}in this game.
          </p>
          <p>
